...
Expression:
          NUMBER                          { $$=TNumber($1); }
        | PI_VAL                          { $$=from_string("3.1415926535897932384626433832795"); }
        | NUMBER PI_VAL                   { $$=from_string("3.1415926535897932384626433832795")*$1; }
        ...
        | FUNC_SIN LEFT_PARENTHESIS Expression RIGHT_PARENTHESIS { $$=sinl(to_double($3)); }
        | FUNC_COS LEFT_PARENTHESIS Expression RIGHT_PARENTHESIS { $$=cosl(to_double($3)); }
        | FUNC_TAN LEFT_PARENTHESIS Expression RIGHT_PARENTHESIS { $$=tanl(to_double($3)); }
        | FUNC_ASIN LEFT_PARENTHESIS Expression RIGHT_PARENTHESIS { $$=asinl(to_double($3)); }
        | FUNC_ACOS LEFT_PARENTHESIS Expression RIGHT_PARENTHESIS { $$=acosl(to_double($3)); }
        | FUNC_ATAN LEFT_PARENTHESIS Expression RIGHT_PARENTHESIS { $$=atanl(to_double($3)); }
        | FUNC_ATAN2 LEFT_PARENTHESIS Expression COMMA Expression RIGHT_PARENTHESIS { $$=atan2l(to_double($3), to_double($5)); }
        | FUNC_SINH LEFT_PARENTHESIS Expression RIGHT_PARENTHESIS { $$=sinhl(to_double($3)); }
        | FUNC_COSH LEFT_PARENTHESIS Expression RIGHT_PARENTHESIS { $$=coshl(to_double($3)); }
        | FUNC_TANH LEFT_PARENTHESIS Expression RIGHT_PARENTHESIS { $$=tanhl(to_double($3)); }
        | FUNC_ASINH LEFT_PARENTHESIS Expression RIGHT_PARENTHESIS { $$=asinhl(to_double($3)); }
        | FUNC_ACOSH LEFT_PARENTHESIS Expression RIGHT_PARENTHESIS { $$=acoshl(to_double($3)); }
        | FUNC_ATANH LEFT_PARENTHESIS Expression RIGHT_PARENTHESIS { $$=atanhl(to_double($3)); }
        | FUNC_LOG10 LEFT_PARENTHESIS Expression RIGHT_PARENTHESIS { $$=log10l(to_double($3)); }
        | FUNC_LOG2 LEFT_PARENTHESIS Expression RIGHT_PARENTHESIS { $$=log2l(to_double($3)); }
        | FUNC_LOG1P LEFT_PARENTHESIS Expression RIGHT_PARENTHESIS { $$=log1pl(to_double($3)); }
        | FUNC_LOG LEFT_PARENTHESIS Expression RIGHT_PARENTHESIS { $$=logl(to_double($3)); }
        | FUNC_LN LEFT_PARENTHESIS Expression RIGHT_PARENTHESIS { $$=logl(to_double($3)); }
        | FUNC_EXP LEFT_PARENTHESIS Expression RIGHT_PARENTHESIS { $$=expl(to_double($3)); }
        | FUNC_EXP2 LEFT_PARENTHESIS Expression RIGHT_PARENTHESIS { $$=exp2l(to_double($3)); }
        | FUNC_SQRT LEFT_PARENTHESIS Expression RIGHT_PARENTHESIS { $$=sqrtl(to_double($3)); }
        | FUNC_CBRT LEFT_PARENTHESIS Expression RIGHT_PARENTHESIS { $$=cbrtl(to_double($3)); }
        | FUNC_ABS LEFT_PARENTHESIS Expression RIGHT_PARENTHESIS { $$=fabsl(to_double($3)); }
        | FUNC_FLOOR LEFT_PARENTHESIS Expression RIGHT_PARENTHESIS { $$=floorl(to_double($3)); }
        | FUNC_CEIL LEFT_PARENTHESIS Expression RIGHT_PARENTHESIS { $$=ceill(to_double($3)); }
        | FUNC_ROUND LEFT_PARENTHESIS Expression RIGHT_PARENTHESIS { $$=roundl(to_double($3)); }
        | FUNC_HYPOT LEFT_PARENTHESIS Expression COMMA Expression RIGHT_PARENTHESIS { $$=hypotl(to_double($3), to_double($5)); }
        | FUNC_POW LEFT_PARENTHESIS Expression COMMA Expression RIGHT_PARENTHESIS { $$=powl(to_double($3), to_double($5)); }
        | FUNC_TGAMMA LEFT_PARENTHESIS Expression RIGHT_PARENTHESIS { $$=tgammal(to_double($3)); }
        | FUNC_LGAMMA LEFT_PARENTHESIS Expression RIGHT_PARENTHESIS { $$=lgammal(to_double($3)); }
        | FUNC_TRUNC LEFT_PARENTHESIS Expression RIGHT_PARENTHESIS { $$=truncl(to_double($3)); }
        | FUNC_NEARBYINT LEFT_PARENTHESIS Expression RIGHT_PARENTHESIS { $$=nearbyintl(to_double($3)); }
        | FUNC_FMOD LEFT_PARENTHESIS Expression COMMA Expression RIGHT_PARENTHESIS { $$=fmodl(to_double($3), to_double($5)); }
        | FUNC_REMAINDER LEFT_PARENTHESIS Expression COMMA Expression RIGHT_PARENTHESIS { $$=remainderl(to_double($3), to_double($5)); }
        | FUNC_NEXTAFTER LEFT_PARENTHESIS Expression COMMA Expression RIGHT_PARENTHESIS { $$=nextafterl(to_double($3), to_double($5)); }
        | FUNC_NEXTTOWARD LEFT_PARENTHESIS Expression COMMA Expression RIGHT_PARENTHESIS { $$=nexttowardl(to_double($3), to_double($5)); }
        | FUNC_FDIM LEFT_PARENTHESIS Expression COMMA Expression RIGHT_PARENTHESIS { $$=fdiml(to_double($3), to_double($5)); }
        | FUNC_FMAX LEFT_PARENTHESIS Expression COMMA Expression RIGHT_PARENTHESIS { $$=fmaxl(to_double($3), to_double($5)); }
        | FUNC_FMIN LEFT_PARENTHESIS Expression COMMA Expression RIGHT_PARENTHESIS { $$=fminl(to_double($3), to_double($5)); }
        | FUNC_FMA LEFT_PARENTHESIS Expression COMMA Expression COMMA Expression RIGHT_PARENTHESIS { $$=fmal(to_double($3), to_double($5), to_double($7)); }
        ...
        | Expression POWER Expression     { $$=powl(to_double($1),to_double($3)); }
...
TNumber calculate_mort(TNumber principal, TNumber interest_rate, TNumber num_years)
{
    ...
    double months = to_double(num_years) * 12.0;
    TNumber monthlyPayment = principal * ( monthlyInterest /
        ( TNumber(1) - powl((1.0 + to_double(monthlyInterest)), (0.0 - months)) ) );
...
{
    TNumber q = from_double(powl(to_double(TNumber(1) + r), to_double(nper)));
    return(r * (fv + (q * pv))) / ((TNumber(-1) + q) * (TNumber(1) + r * (type)));
}

TNumber calculate_ytm(TNumber couponRate, TNumber yearsToMaturity, TNumber parValue, TNumber price)
{
    TNumber yrs = roundl(to_double(yearsToMaturity));
...
{
    long long ytm_i = to_int(yearsToMaturity);

    TNumber price(0);
    for (long long i = 1 ; i <= ytm_i ; ++i)
        price += (annualCouponPayment * pow(to_double(proposedRate + TNumber(1)), (i * -1)));

    price += parValue * pow(to_double(proposedRate + TNumber(1)), to_double(yearsToMaturity * TNumber(-1)));
    return price;
}
...
TNumber calculate_rand(TNumber a)
{
    ...
    return rand() % (to_int(a));
}

TNumber calculate_srand(TNumber a)
{
    srand(static_cast<unsigned long long>(to_int(a)));
    return TNumber(1);
}
...
{
    unsigned long long ni = static_cast<unsigned long long>(to_int(n));
    unsigned long long ri = static_cast<unsigned long long>(to_int(r));
...
{
    long long imin = (long long) fminl(fabsl(to_double(a)),fabsl(to_double(b)));
    long long imax = (long long) fmaxl(fabsl(to_double(a)),fabsl(to_double(b)));
...
{
    long long ai = to_int(a);
    long long bi = to_int(b);
